package shiyiliang.me.baselibary.view.popupwindow;
...
public class CommonPopupWindow extends PopupWindow {
    ...
    public void dismiss() {
        super.dismiss();
        controller.setBackGroundLevel(1.0f, false);
    }
    ...
    public static class Builder {
         ...
         * 设置背景灰色程度
         *
         * @param level 0.0f（完全透明）-1.0f(不透明)
         * @return Builder
         */
        public Builder setBackGroundLevel(float level, boolean transparent) {
